...
class CardioAlignLoss(nn.Module):
    ...
    # def instance_normalize(self, x: torch.Tensor) -> torch.Tensor:
    #     """ 
    #     Chuẩn hóa từng mẫu (instance) độc lập.
    #     Input x có dạng [Batch, Features].
    #     """
    #     # Tính Mean và Var theo chiều Features (dim=1)
