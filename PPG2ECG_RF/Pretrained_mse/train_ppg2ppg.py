...
class TrainConfig:
    ...
    save_dir: str = "/home/linhhima/PPG_ECG/PPG2ECG_RF/Pretrained_mse/saved_models_ppg_ae_subject"
...
def main():
    ...
    # Removed deprecated 'verbose' parameter to prevent PyTorch 2.0+ warnings/errors
    ...
    for epoch in range(1, CFG.epochs + 1):
        # Store previous Learning Rate before epoch update for manual tracking
        ...
        # Manual logging logic replacing deprecated verbose flag
        ...
        # 4. Save Checkpoint & Early Stopping Check
