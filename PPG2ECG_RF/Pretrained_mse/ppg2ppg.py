...
class GRN1D(nn.Module):
    """ Global Response Normalization (GRN) 1D for ConvNeXt V2 """
...
# ============================================================
# PPG Standard Autoencoder Complete Model (Deterministic AE)
# ============================================================
...
# ============================================================
# PPG Reconstruction Loss (L1 Loss + Pearson Correlation)
# ============================================================
...
if __name__ == "__main__":
    ...
    print("--- PPG AUTOENCODER SANITY CHECK COMPLETED ---")
