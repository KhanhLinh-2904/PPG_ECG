...
class PPGAEConfig:
    ...
    # Global branch decoder configuration
...
class GRN1D(nn.Module):
    """ Global Response Normalization 1D for ConvNeXt V2 """
...
# ============================================================
# Decomposable Global Trend Branch
# ============================================================
...
# ============================================================
# PPG Decoder
# Input: z [B, latent_channels, 75] -> Output: PPG [B, 1, 2400]
# ============================================================
class PPGDecoder1D(nn.Module):
    def __init__(self, cfg: PPGAEConfig):
        ...
        # Global refinement branch from flattened latent sequence
...
# ============================================================
# PPG Standard Autoencoder Full Model (Deterministic Autoencoder)
# ============================================================
...
# ============================================================
# PPG Loss Function (L1 Loss + Pearson Correlation Coefficient)
# ============================================================
class PPGReconstructionLoss(nn.Module):
    ...
    def forward(self, outputs: Dict[str, torch.Tensor], target_ppg: torch.Tensor) -> Dict[str, torch.Tensor]:
        # Synchronize reconstruction output key
        recon = outputs["reconstructed_ppg"]
        
        # 1. Compute L1 Loss
        loss_l1 = self.l1_loss(recon, target_ppg)
        
        # 2. Compute Pearson Loss (waveform shape correlation)
...
if __name__ == "__main__":
    ...
    # Create dummy PPG input tensor: [Batch size=2, Channels=1, Length=2400]
    ...
    print("--- PPG AE MODEL OUTPUT SANITY CHECK COMPLETED ---")
