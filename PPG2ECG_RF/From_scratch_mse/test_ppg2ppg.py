...
MODEL_PATH = '/home/linhhima/PPG_ECG/PPG2ECG_RF/From_scratch_mse/saved_models_ppg_ae_segment/best_ppg_autoencoder.pth'
...
def load_model():
    print(f"[*] Loading PPG Autoencoder model to {DEVICE}...")
        ...
        for batch_data in test_loader:
            ...
            for idx in range(ppg_true_np.shape[0]):
                ...
                if len(seen_records) >= 5:
                    print("[*] Displayed 5 demo samples.")
                    return
...
def run_loss():
    ...
    print("\n[*] Calculating PPG signal error metrics...")
    with torch.no_grad():
        for batch_data in test_loader:
            ppg = batch_data[1]
