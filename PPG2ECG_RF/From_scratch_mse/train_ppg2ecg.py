...
class TrainConfig:
    ...
    save_dir: str = "/home/linhhima/PPG_ECG/PPG2ECG_RF/From_scratch_mse/saved_models_alignment_segment"
...
def main():
    ...
    print("[+] Successfully initialized PPG Student model from scratch.")
