...
PHASE1_PPG_PATH = '/home/linhhima/PPG_ECG/PPG2ECG_RF/From_scratch_mse/saved_models_alignment_segment/best_ppg_alignment.pth'
PHASE2_FLOW_PATH = '/home/linhhima/PPG_ECG/PPG2ECG_RF/From_scratch_mse/saved_models_flow_segment/best_rectified_flow.pth'
            ...
            for i in range(ppg.shape[0]):
                ...
                if rec_name in target_records and rec_name not in seen_records:
                    ...
                    if len(seen_records) == len(target_records):
                        print("\n[*] All target records displayed. Finished!")
                        return
...
if __name__ == "__main__":
    save_ecg_reconstruction("/home/linhhima/PPG_ECG/AF_Detection/reconstructed_ecg/total_mimic_af_flow_segment_mse.npz")